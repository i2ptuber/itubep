...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "publish.choose_thumbnail_title": "Выберите картинку для превью (необязательно)",
        "publish.filetype_image": "Изображения",
        "publish.ok_btn": "OK",
        ...
        "assemble.arg_quality": "Качество для сборки (360p/480p/720p/1080p) — папка теперь содержит сегменты всех качеств видео вперемешку",
    ...
    "en": {
        ...
        "publish.choose_thumbnail_title": "Choose a thumbnail image (optional)",
        "publish.filetype_image": "Images",
        "publish.ok_btn": "OK",
        ...
        "assemble.arg_quality": "Quality to assemble (360p/480p/720p/1080p) — the folder now holds segments of all qualities mixed together",
