...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "publish.description": "First choose a video file through the local ITubeP Bridge "
                                 "(it will ask you to confirm the request and pick the file), "
                                 "then fill in the title and description right here on the site.",
    ...
    "ru": {
        ...
        "publish.description": "Сначала выберите видеофайл через локальный ITubeP Bridge "
                                 "(он попросит подтвердить запрос и выбрать файл), а затем "
                                 "заполните название и описание прямо здесь, на сайте.",
